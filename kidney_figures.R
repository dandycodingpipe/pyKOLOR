...
cortex <- renalLoad("r_cortex", group = "s")
medulla <- renalLoad("r_medulla", group = "s")
pelvis <- renalLoad("r_pelvis", group = "s")

cortex_stats <- vesselStats(cortex)
medulla_stats <- vesselStats(medulla)
pelvis_stats <- vesselStats(pelvis)
